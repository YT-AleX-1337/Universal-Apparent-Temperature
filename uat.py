...
T_WC = 13.12 - 0.379 * T - (11.37 - 0.397 * T) * (W + 1) ** 0.16 #Calculate the wind effect (it lowers the apparent temperature when it's cold and slightly increase it when it's hot)
w = 1.5 / (1 + exp(0.1 * T + (W + 1) ** 0.16 - 4)) - 0.5 #Calculate wind factor: the higher the temperature, the least effect wind has
